// This file mostly exists because we want dev mode to say "CornerstoneCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "CornerstoneCode (Dev)" : "CornerstoneCode (Alpha)";
...
const developmentMacIconPngPath = join(repoRoot, "assets", "dev", "cornerstone-macos-1024.png");
